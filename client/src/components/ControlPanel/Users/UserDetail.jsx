    ...
    return (
        <StyledUserDetail>
            <div >
                ...
                <Button className="btn" variant="contained" color="secondary" >Eliminar Usuario</Button>
                <Button className="btn" variant="contained"  >Forzar reinicio de contraseña</Button>
            </div>
        </StyledUserDetail>
    )
};
